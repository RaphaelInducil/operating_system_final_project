# 6/9/2026
# Disk Management Simulation: LOOK Algorithm
...
def calculate_look(initial_head: int, requests: list[int]) -> dict:
    """Moves to the highest request, then reverses to the lowest request."""
...
if __name__ == "__main__":
    ...
    results = calculate_look(initial_head, requests)
