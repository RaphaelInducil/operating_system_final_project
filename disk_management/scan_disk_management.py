...
ALGORITHM_NAME = "SCAN Algorithm (Elevator)"
MAX_CYLINDER = 199
MIN_CYLINDER = 0
NUM_REQUESTS = 8
...
def calculate_scan(initial_head: int, requests: list[int]) -> dict:
    """Moves towards 0 first, then reverses direction."""
    pending = requests.copy()
    
    # SCAN goes to the end of the disk (0 in this direction)
...
if __name__ == "__main__":
    ...
    results = calculate_scan(initial_head, requests)
