# 6/9/2026
# Disk Management Simulation: C-LOOK Algorithm (Circular LOOK)
...
ALGORITHM_NAME = "C-LOOK Algorithm (Circular LOOK)"
MAX_CYLINDER = 199
MIN_CYLINDER = 0
NUM_REQUESTS = 8
...
def calculate_c_look(initial_head: int, requests: list[int]) -> dict:
    """Moves to the highest request, jumps to the lowest request, and continues."""
...
if __name__ == "__main__":
    ...
    results = calculate_c_look(initial_head, requests)
